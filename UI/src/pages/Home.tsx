...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <div className="flex-grow grid grid-cols-1 grid-rows-4 py-20 md:grid-cols-2 md:grid-rows-2">
        <div className="flex flex-col justify-center  bg-vanilla h-full p-10 outline outline-jet outline-1">
        ...
        <div className="flex flex-col justify-center  bg-coral border-b h-full p-10 outline outline-jet outline-1">
